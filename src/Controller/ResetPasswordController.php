    ...
    public function index(Request $request)
    {
        ...
        if ($request->get('email')){
            ...
            if($user){
                ...
                $content = "Bonjour".$user->getFirstname()."<br/> Vous avez demandez à réinitialiser votre mot de passe sur le site La Boutique Barajoss.<br/><br/>";
                $content .= "Merci de cliquer le lien suivant pour <a href='".$url."'>mettre à jour votre mot de passe</a>. ";
                $email = new Mail();
                $email->send($user->getEmail(), $user->getFirstname().' '.$user->getLastname(),'Réinitialiser votre mot de passe sur La Boutique Barajoss',$content);
