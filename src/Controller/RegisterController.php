...
class RegisterController extends AbstractController
{
    ...
    public function index(Request $request, UserPasswordHasherInterface $hasher)
    {
            ...
            if ($form->isSubmitted() && $form->isValid()){
                ...
                $email = new Mail();
                $content = "Bonjour".$user->getFirstName()."<br> Bienvenue sur la boutique du vin Espagnol.</br>";
                $email->send($user->getEmail(), $user->getFirstName(), 'Bienvenue sur la Boutique Barajoss', "$content");
